#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_pigs_8shots_1seed
#SBATCH --output=logs_scripts/CLIP-LoRA_pigs_8shots_1seed.out
#SBATCH --error=error_scripts/CLIP-LoRA_pigs_8shots_1seed.err
#SBATCH --mem=32G
