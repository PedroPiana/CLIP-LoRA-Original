#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_pigs_16shots_4seed
#SBATCH --output=logs_scripts/CLIP-LoRA_pigs_16shots_4seed.out
#SBATCH --error=error_scripts/CLIP-LoRA_pigs_16shots_4seed.err
#SBATCH --mem=32G
