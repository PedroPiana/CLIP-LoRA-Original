#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_pigs_2shots_2seed
#SBATCH --output=logs_scripts/CLIP-LoRA_pigs_2shots_2seed.out
#SBATCH --error=error_scripts/CLIP-LoRA_pigs_2shots_2seed.err
#SBATCH --mem=32G
